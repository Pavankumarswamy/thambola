...
const User = () => {
  ...
  const addMoneyToWallet = async () => {
    ...
    try {
      ...
      // Initialize payment with order creation
      await initializeRazorpayPayment(
        amount,
        async (paymentId, orderId) => {
          console.log('Payment successful with ID:', paymentId, 'Order ID:', orderId);
          ...
          try {
            ...
            const { error: transactionError } = await supabase
              ...
              .insert({
                ...
                type: "credit",
                amount,
                reason: `Wallet top-up via Razorpay (Payment: ${paymentId}, Order: ${orderId})`
              });
